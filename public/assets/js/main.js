(function($) {
    ...
    $('.slider-active-2').owlCarousel({
        ...
        animateOut: 'fadeOut',
        animateIn: 'fadeIn',
        navText: ['<img src="public/assets/img/icon-img/57.png"> next', 'prev <img src="public/assets/img/icon-img/58.png">'],
        item: 1,
        responsive: {
            0: {
                items: 1
    ...
    $('.popular-product-active').owlCarousel({
        ...
        item: 4,
        margin: 57,
        navText: ['<img src="public/assets/img/icon-img/left.png">', '<img src="public/assets/img/icon-img/right.png">'],
        responsive: {
            0: {
                items: 1
            },
