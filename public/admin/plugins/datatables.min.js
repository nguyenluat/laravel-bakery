...
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.SIMPLE_FROUND_POLYFILL = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, f, e) { b != Array.prototype && b != Object.prototype && (b[f] = e.value) };
$jscomp.getGlobal = function(b) { b = ["object" == typeof window && window, "object" == typeof self && self, "object" == typeof global && global, b]; for (var f = 0; f < b.length; ++f) { var e = b[f]; if (e && e.Math == Math) return e } throw Error("Cannot find global object"); };
$jscomp.global = $jscomp.getGlobal(this);
...
$jscomp.Symbol = function() {
    function b(e) { if (this instanceof b) throw new TypeError("Symbol is not a constructor"); return new $jscomp.SymbolClass($jscomp.SYMBOL_PREFIX + (e || "") + "_" + f++, e) } var f = 0; return b }();
...
$jscomp.iteratorFromArray = function(b, f) { $jscomp.initSymbolIterator();
    b instanceof String && (b += ""); var e = 0,
        m = { next: function() { if (e < b.length) { var k = e++; return { value: f(k, b[k]), done: !1 } }
                m.next = function() { return { done: !0, value: void 0 } }; return m.next() } };
    m[Symbol.iterator] = function() { return m }; return m };
$jscomp.polyfill = function(b, f, e, m) { if (f) { e = $jscomp.global;
        b = b.split("."); for (m = 0; m < b.length - 1; m++) { var k = b[m];
            k in e || (e[k] = {});
            e = e[k] }
        b = b[b.length - 1];
        m = e[b];
...
(function(b) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(f) { return b(f, window, document) }) : "object" === typeof exports ? module.exports = function(f, e) { f || (f = window);
        e && e.fn.dataTable || (e = require("datatables.net")(f, e).$); return b(e, f, f.document) } : b(jQuery, window, document) })(function(b, f, e, m) {
    ...
    b.extend(l.prototype, {
        ...
        enable: function(a) { var d = this; if (!1 === a) return this.disable();
            this.s.enabled = !0;
            this._focusListener();
            this.dom.handle.on("mousedown", function(a) { d._mousedown(a); return !1 }); return this },
        ...
        _actionSelector: function(a) {
            var d = this,
                ...
                g = l.actions,
                h = [];
            b.each(g, function(d, b) { b.available(c, a) && h.push(d) });
            if (1 === h.length && !1 === this.c.alwaysAsk) { var e = g[h[0]].execute(c, a);
                this._update(e, a) } else if (1 < h.length) {
                var f = this.dom.list.children("ul").empty();
                h.push("cancel");
                b.each(h, function(h, e) { f.append(b("<li/>").append('<div class="dt-autofill-question">' + g[e].option(c, a) + "<div>").append(b('<div class="dt-autofill-button">').append(b('<button class="' + l.classes.btn + '">' + c.i18n("autoFill.button", "&gt;") + "</button>").on("click", function() { var h = g[e].execute(c, a, b(this).closest("li"));
                        d._update(h, a);
        ...
        _editor: function(a) {
            ...
            if (c) {
                for (var b = {},
                    ...
                    for (var l = 0, p = a[f].length; l < p; l++) { var q = a[f][l],
                            n = d.settings()[0].aoColumns[q.index.column],
                            r = n.editField; if (r === m) { n = n.mData; for (var u = 0, y = e.length; u < y; u++) { var w = c.field(e[u]); if (w.dataSrc() === n) { r = w.name(); break } } } if (!r) throw "Could not automatically determine field data. Please see https://datatables.net/tn/11";
                        b[r] || (b[r] = {});
        ...
        _focusListener: function() {
            ...
            if ("focus" === g) d.on("key-focus.autoFill", function(c, b, d) { a._attach(d.node()) }).on("key-blur.autoFill", function(c, b, d) { a._detach() });
            else if ("click" === g) b(d.table().body()).on("click" + c, "td, th", function(c) { a._attach(this) }), b(e.body).on("click" + c, function(c) {
        ...
        _mousedown: function(a) {
            ...
            b(e.body).on("mousemove.autoFill", function(a) { d._mousemove(a) }).on("mouseup.autoFill", function(a) { d._mouseup(a) });
        ...
        _mousemove: function(a) { var b = a.target.nodeName.toLowerCase(); if ("td" === b || "th" === b) this._drawSelection(a.target, a), this._shiftScroll(a) },
        _mouseup: function(a) {
            ...
            if (g.row !== h.row || g.column !== h.column) {
                ...
                if (b("div.DTE", f.node()).length) {
                    var k = c.editor();
                    k.on("submitSuccess.dtaf close.dtaf", function() { k.off(".dtaf");
                    ...
                    h = [];
                    for (var v = c.settings()[0], p = v.aoColumns, q = c.columns(this.c.columns).indexes(), n = 0; n < l.length; n++) h.push(b.map(g, function(a) { var b = c.row(":eq(" + l[n] + ")", { page: "current" });
                        a = c.cell(b.index(), a + ":visible");
                        b = a.data(); var d = a.index(),
                            g = p[d.column].editField;
                        g !== m && (b = v.oApi._fnGetObjectDataFn(g)(c.row(d.row).data())); if (-1 !== q.indexOf(d.column)) return { cell: a, data: b, label: a.data(), index: d } }));
        ...
        _range: function(a, b) { var c = []; if (a <= b)
                for (; a <= b; a++) c.push(a);
            else
                for (; a >= b; a--) c.push(a); return c },
        ...
        _update: function(a, b) { if (!1 !== a) { a = this.s.dt; var c = a.columns(this.c.columns).indexes();
                this._emitEvent("preAutoFill", [a, b]);
                this._editor(b); if (null !== this.c.update ? this.c.update : !this.c.editor) { for (var d = 0, h = b.length; d < h; d++)
                        for (var e = 0, f = b[d].length; e < f; e++) { var k = b[d][e]; - 1 !== c.indexOf(k.index.column) && k.cell.data(k.set) }
                    a.draw(!1) }
                this._emitEvent("autoFill", [a, b]) } }
    });
    l.actions = {
        increment: {
            available: function(a, b) { a = b[0][0].label; return !isNaN(a - parseFloat(a)) },
            option: function(a,
                b) { return a.i18n("autoFill.increment", 'Increment / decrement each cell by: <input type="number" value="1">') },
            execute: function(a, d, c) { a = 1 * d[0][0].data;
                c = 1 * b("input", c).val(); for (var g = 0, e = d.length; g < e; g++)
        ...
        fillHorizontal: { available: function(a, b) { return 1 < b.length && 1 < b[0].length }, option: function(a, b) { return a.i18n("autoFill.fillHorizontal", "Fill cells horizontally") }, execute: function(a, b, c) { a = 0; for (c = b.length; a < c; a++)
                    for (var d = 0, e = b[a].length; d < e; d++) b[a][d].set = b[a][0].data } },
        fillVertical: {
            available: function(a, b) { return 1 < b.length },
    ...
    t.register("autoFill().enabled()", function() { var a = this.context[0]; return a.autoFill ? a.autoFill.enabled() : !1 });
    t.register("autoFill().enable()",
        function(a) { return this.iterator("table", function(b) { b.autoFill && b.autoFill.enable(a) }) });
    t.register("autoFill().disable()", function() { return this.iterator("table", function(a) { a.autoFill && a.autoFill.disable() }) });
    b(e).on("preInit.dt.autofill", function(a, d, c) { "dt" === a.namespace && (a = d.oInit.autoFill, c = k.defaults.autoFill, a || c) && (c = b.extend({}, a, c), !1 !== a && new l(d, c)) });
    k.AutoFill = l;
    return k.AutoFill = l
});